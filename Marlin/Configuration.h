...
#define STRING_CONFIG_H_AUTHOR "(Zekitez, SapphirePlus)" // Who made the changes.
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 10 // 25 If the temperature difference between the target temperature and the actual temperature
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, -39.6, 0 }            // See Youtube Aurora Tech, values depend on used bracket !!!
#else
...
#define PROBING_MARGIN 20                               // Set as suggested by Aurora Tech when clips are used to hold the glass bed.
...
#define Y_BED_SIZE 305 // To stop pulleys hitting stepper mounts, was 295

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0    // -5 Centre printable area on the bed
#define Y_MIN_POS 0
#define Z_MIN_POS 0
...
//#endif
  ...
  #define FIL_RUNOUT_PIN PA4             // MKS Robin Nano v1.2 MT_DET_1
